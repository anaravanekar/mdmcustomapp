...
/*		writer.add("<tr><td colspan=\"1\" nowrap=\"nowrap\" style=\"" + CELL_STYLE_RIGHT + "\"><font color=\"#606060\">");
		...
		writer.addJS("function getLookupValues(){  var resultObj = null;     var urlForOptions = '"+protocol+"://"+host+":"+port+"/mdmcustomapp/getLookupValues';     var xhr = new XMLHttpRequest();     xhr.open(\"GET\", urlForOptions);     xhr.onload = function() {         if (xhr.status === 200) {             resultObj = JSON.parse(xhr.responseText);    return resultObj;         }else{    return resultObj;   }     };     xhr.send(); }");
	}
}
