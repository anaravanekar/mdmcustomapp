...
/*		writer.add("<tr><td colspan=\"1\" nowrap=\"nowrap\" style=\"" + CELL_STYLE_RIGHT + "\"><font color=\"#606060\">");
		...
		writer.addJS("function getRecord(dataspace,dataset,object,objectId,account) {     var url = '"+protocol+"://"+host+":"+port+"/mdmcustomapp/getRecord/'+dataspace+'/'+dataset+'/'+object+'/'+objectId; var xhr = new XMLHttpRequest();     xhr.open(\"GET\", url, false);     xhr.onload = function() {         if (xhr.status === 200) {             var obj = JSON.parse(xhr.responseText);             account=obj.content;                    } else {             account=null;         }     };     xhr.send(); }");
