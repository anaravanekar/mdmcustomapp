...
//			writer.add("<td class=\"ebx_Input\" colspan=\"1\">");
			writer.addWidget(_AssignedTo);
//			writer.add("</td>");
//			writer.add("<td colspan=\"1\" style=\"width:25%;  vertical-align:top;\" nowrap=\"nowrap\" color=\"#606060\">");
			writer.addButtonJavaScript(new UIButtonSpecJSAction(buttonLabel,"saveAssignmentProspect('"+dataSpace+"',ebx_form_getValue(\""+writer.getPrefixedPath(_AssignedTo).format()+"\"),'account','"+systemId+"')"));
//			writer.add("</td>");
			writer.endFormRow();
		}else{
