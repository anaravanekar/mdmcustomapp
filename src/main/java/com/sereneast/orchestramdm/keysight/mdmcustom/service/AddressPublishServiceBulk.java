...
public class AddressPublishServiceBulk extends PublishServiceBulk {

    private static final Logger LOGGER = LoggerFactory.getLogger(AddressPublishServiceBulk.class);

    public AddressPublishServiceBulk() throws ClassNotFoundException, IllegalAccessException {
        super();
