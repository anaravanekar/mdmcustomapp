...
public class AccountController {
	...
	private static final String COLUMN_LIST_ACCOUNT ="MDMACCOUNTID,INTERNALACCOUNTID,ACCOUNTNAME,DAQAMETADATA_STATE,DAQAMETADATA_CLUSTERID,DAQAMETADATA_SCORE,STATUS,SYSTEMID,SYSTEMNAME,CUSTOMERTYPE,REGISTRYID,NAMEPRONUNCIATION,TAXPAYERID,TAXREGISTRATIONNUMBER,CUSTOMERCATEGORY,REGION,CLASSIFICATION,ACCOUNTTYPE,SALESCHANNEL,REFERENCE,NLSLANGUAGECODE,NAMELOCALLANGUAGE,CUSTOMERSCREENING,PARENTPARTY,EMGLASTTRANS,GROUPINGDESCRIPTION,GROUPINGID,PROFILECLASS,ASSIGNEDTO,ISGCLASSIFICATION,NOTES,PAYMENTENDDATE,PAYMENTRECEIPTMETHOD,PAYMENTSTARTDATE,PRIMARYPAYMENT,PUBLISHED";
