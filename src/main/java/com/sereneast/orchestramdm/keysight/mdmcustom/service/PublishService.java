                        ...
                        for(String operatingUnit:operatingUnits){
                            ...
                            if (childrenToUpdateInJitterbit != null && !childrenToUpdateInJitterbit.isEmpty()) {
                                ...
                                if(!businessPurposesFinal.isEmpty()) {
                                    businessPurposesFinal.sort((OrchestraObject s1, OrchestraObject s2)->s1.getContent().get("BusinessPurpose").getContent().toString().compareTo(s2.getContent().get("BusinessPurpose").getContent().toString()));
