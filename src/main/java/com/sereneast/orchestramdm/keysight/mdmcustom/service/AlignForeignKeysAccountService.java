...
public class AlignForeignKeysAccountService extends RealignForeignKeysService {

    private static final Logger LOGGER = LoggerFactory.getLogger(AlignForeignKeysAccountService.class);
