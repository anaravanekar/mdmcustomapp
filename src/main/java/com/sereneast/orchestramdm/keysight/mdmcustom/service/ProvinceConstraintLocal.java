...
public class ProvinceConstraintLocal implements Constraint {

    private static final Logger LOGGER = LoggerFactory.getLogger(ProvinceConstraintLocal.class);
    ...
    public void checkOccurrence(Object o, ValueContextForValidation valueContextForValidation) {
        ...
        String currentProvince = valueContextForValidation.getValue(Path.PARENT.add(Paths._Address._ProvinceLocalLanguage)) != null ?
                String.valueOf(valueContextForValidation.getValue(Path.PARENT.add(Paths._Address._ProvinceLocalLanguage))) : null;
